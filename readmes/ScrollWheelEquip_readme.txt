...
Scroll Wheel Equip is released under the MIT License. See ScrollWheelEquip_license.txt for more info.
...
Mods that add their own hand-held lights/torches that can be carried in the off-hand: These light items won't be detected and won't be switched to when scrolling the left hand. Only vanilla torches are supported.
